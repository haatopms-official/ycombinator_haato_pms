...
-- Compare-and-swap RPC used by the client sync layer. Runs as SECURITY DEFINER
-- so callers (anon/authenticated) can atomically upsert without direct table access.
