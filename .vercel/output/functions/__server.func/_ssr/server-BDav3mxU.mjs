...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Clatw6Kc.mjs");
...
const manifest = {
  "114603339148d6b7cfbc2a9a16d7c155014b773beb6587879438626e7354f351": {
    functionName: "setHotelState_createServerFn_handler",
    importer: () => import("./hotel-state.functions-DSwK6Mi8.mjs")
  },
  "89b60288b8b232346474bc8bf300257346a58b7164121f204f414697ad1faac3": {
    functionName: "getHotelState_createServerFn_handler",
    importer: () => import("./hotel-state.functions-DSwK6Mi8.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D8HlAbG0.mjs").then((n) => n.r),
    import("./start-CxZ5zca-.mjs"),
